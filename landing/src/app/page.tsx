...
function JiraIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path d="M11.53,2a4.37,4.37,0,0,0,4.35,4.35h1.78v1.7A4.35,4.35,0,0,0,22,12.4V2.84A.85.85,0,0,0,21.16,2H11.53M6.77,6.8a4.36,4.36,0,0,0,4.34,4.34h1.8v1.72a4.36,4.36,0,0,0,4.34,4.34V7.63a.84.84,0,0,0-.83-.83H6.77M2,11.6a4.34,4.34,0,0,0,4.35,4.34H8.13v1.72A4.36,4.36,0,0,0,12.47,22V12.43a.85.85,0,0,0-.84-.84H2Z" fill="url(#jira-gradient)" />
      <defs>
        <linearGradient id="jira-gradient" x1="2" y1="12" x2="22" y2="12" gradientUnits="userSpaceOnUse">
      ...
      >
        {allLogos.map((logo, i) => (
          <div key={i} className="flex items-center gap-3 opacity-40 hover:opacity-80 transition-opacity">
            ...
            <span className="text-sm font-medium text-[#a1a1aa] whitespace-nowrap">{logo.name}</span>
          </div>
        ))}
      </motion.div>
    </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-[#a1a1aa] text-lg max-w-2xl mx-auto">
            Connect your favorite tools and manage your AI agents on the go.
            Integrate with Telegram, Slack, GitHub, and JIRA for seamless workflows.
          </p>
        </motion.div>
  ...
  const features = [
    {
      ...
      description: "A powerful orchestrator that coordinates all your agents. Give it high-level tasks and watch it delegate work automatically.",
    ...
    },
    {
      ...
      description: "Model Context Protocol server for programmatic agent control. Super Agent uses MCP tools to orchestrate your fleet.",
