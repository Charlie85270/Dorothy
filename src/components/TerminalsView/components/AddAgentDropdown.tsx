  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-muted-foreground hover:text-foreground hover:bg-white/5 transition-colors"
        title="Add existing agent to this tab"
      >
        <ChevronDown className="w-3 h-3" />
        <span className="hidden sm:inline">Add to Tab</span>
      </button>
